...
#########################################################################
# To run script:                                                        #
# 1. Specify folder name where PDFs are located, e.g. PDFs in this case #
# 2. Give a desired name for the destination, e.g. extracted_files      #
# 3. Open the terminal and type: python3 image_extractor.py"            #
#########################################################################
